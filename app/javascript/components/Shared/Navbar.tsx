    ...
    Object.entries(items).length > 0 ? (
      Object.entries(items).map(([tag, state], i) => (
        <ListItem
          button
          key={i + 1}
          onClick={() => handleClick({ [tag]: !state })}
        >
          <ListItemIcon>
            <Checkbox color="primary" checked={state} />
          </ListItemIcon>
      ...
      <ListItem>
        <ListItemText>
          {" "}
          You don't have any tags. <br />
          Try adding some by clicking View Task, then going to Add tag!
        </ListItemText>
      </ListItem>
    );
      ...
      >
        <List style={{ marginTop: 60 }}>
          ...
          <ListItem
            ...
            style={{
              backgroundColor:
                currentTab === "Completed Tasks" ? "#91c5ff" : "",
              borderRadius: 10,
            }}
          >
            <ListItemIcon>
